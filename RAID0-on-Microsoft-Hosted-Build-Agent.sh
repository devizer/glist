...
Colorize LightGreen "     SSD_SWAP_MB: $SSD_SWAP_MB"
...
function Setup-Raid0-on-Loop() {
    ...
    local freeSpaceAligned=$((freeSpace-FREE_SECOND_DRIVE_SPACE_MB*1024-SSD_SWAP_MB*1024))
    # root
