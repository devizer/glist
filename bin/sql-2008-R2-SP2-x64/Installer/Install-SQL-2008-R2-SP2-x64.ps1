...
$target="C:\SQL\2008-R2-x86-Express"
cmd /c setup.exe /Action=Install /ADDCURRENTUSERASSQLADMIN /IACCEPTSQLSERVERLICENSETERMS /ENU /FEATURES=SQLENGINE /INSTANCENAME=SQL2008R2 /SECURITYMODE=SQL /SAPWD=`1qazxsw2 /TCPENABLED=1 /NPENABLED=1 /INDICATEPROGRESS /QS /INSTANCEDIR="$target"
