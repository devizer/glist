...
ENTRYPOINT echo Starting 5 Services; \
  ...
  (nohup mongod --bind_ip 0.0.0.0 --port 27017 --dbpath /var/lib/mongodb/data --smallfiles --nssize 8 --wiredTigerCacheSizeGB 1 --logpath /var/log/mongod.log & ); \
...
echo Starting Mongo DB Server
rm -f /var/lib/mongodb/data/mongod.lock || true
mongod --bind_ip 0.0.0.0 --port 27017 --dbpath /var/lib/mongodb/data --smallfiles --nssize 8 --wiredTigerCacheSizeGB 1 --logpath /var/log/mongod.log
while true; do sleep 1; done;
_ENTRY_
chmod +x entry.sh
